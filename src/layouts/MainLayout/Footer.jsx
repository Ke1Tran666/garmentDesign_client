                ...
                <div className="md:col-span-4">
                    ...
                    <div className="flex gap-3 mt-6">
                        {socials.map(({ href, icon: Icon },i)=>(
                            <a key={i} href={href} className="w-9 h-9 rounded-xl border border-border flex items-center justify-center text-subtle hover:text-brand hover:border-brand/30 hover:bg-brand-50 transition-all duration-300">
